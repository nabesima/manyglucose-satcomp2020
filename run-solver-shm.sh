...
if [ $# -lt 5 ] ; then
    echo "USAGE: "
    echo "run-solver.sh PROFILE PROJECT_NAME COMP_S3_PROBLEM_PATH NUM_THREADS JOB_NAME_SUFFIX COMP_OPTIONS "
    echo "where: "
    ...
    echo "   NUM_THREADS is the number of threads to be invoked"
